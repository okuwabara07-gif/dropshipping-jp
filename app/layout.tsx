...
export const metadata: Metadata = {
  title: 'ドロップシッピングLab',
  description: 'ドロップシッピング情報',
  openGraph: { title: 'ドロップシッピングLab', description: 'ドロップシッピング情報', type: 'website', locale: 'ja_JP', siteName: 'ドロップシッピングLab' },
  twitter: { card: 'summary_large_image', title: 'ドロップシッピングLab', description: 'ドロップシッピング情報' },
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "ドロップシッピングLab", "description": "ドロップシッピング情報", "url": "https://dropshipping-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}
